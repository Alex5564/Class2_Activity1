...
spritel2 = Sprite(pygame.Color('red'), 20, 30)
spritel2.rect.x, spritel2.rect.y = random.randint(0, SCREEN_WIDTH - spritel2.rect.width), random.randint(0, SCREEN_HEIGHT - spritel2.rect.height)
all_sprites.add(spritel2)
...
while running:
    ...
    if not won:
        ...
        if spritel.rect.colliderect(spritel2.rect):
            all_sprites.remove(spritel2)
            won = True
        ...
        if won:
            ...
            screen.blit(win_text, ((SCREEN_WIDTH - win_text.get_width()) //2, (SCREEN_HEIGHT - win_text.
            get_height()) //2))
